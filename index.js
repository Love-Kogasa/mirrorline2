...
(function(){
  var express, fs, url, path, engine, cookieParser, proxy, app, loadBody, getParams, port;
  ...
  app.all("/proxy*", function(req, res){
    if (req.cookies.url) {
      ...
      return proxy(req.cookies.url)(req, res, function(){});
    } else {
      return res.send(loadBody("assets/proxy.html", "Proxy"));
    }
  });
